...
public class NewRedPathPoses {
    public static Pose StartRedPose = new Pose(78.10526315789475,7.368421052631579);
    public static Pose RedLowZonePose = new Pose(81.89473684210526, 26.315789473684173);
    ...
    public static Pose RedLoadZone = new Pose(141.26315789473682, 4.8421052631578725);
