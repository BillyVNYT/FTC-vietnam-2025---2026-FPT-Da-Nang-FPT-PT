...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = 3.484352; // X is the up and down direction
    public static double PARALLEL_Y = -2.5645669; // Y is the strafe direction

    public static double PERPENDICULAR_X = -3.484352;
    public static double PERPENDICULAR_Y = -2.5645669;
