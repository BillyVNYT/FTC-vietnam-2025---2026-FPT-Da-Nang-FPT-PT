...
public class RedPathPoses {
    ...
    public static Pose RedPickUpLow = new Pose(115.157894736842092, 35.894736842105274);
    public static Pose RedLeavePose = new Pose(113.26315789473683, 35.631578947368425);
